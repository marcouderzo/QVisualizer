...
MainWindow::MainWindow(QWidget *parent)
{
    ...
    connect(this, SIGNAL(updateProperties(std::string, std::string, std::string, bool, std::string, std::string, unsigned int, unsigned int, unsigned int, unsigned int)), m_MediaPropertiesWidget, SLOT(onUpdateProperties(const std::string&, const std::string&, const std::string&, bool, const std::string&, const std::string&, unsigned int, unsigned int, unsigned int, unsigned int)));
